package br.com.creativesource.spark;
...
import spark.Route;
import br.com.creativesource.spark.domain.Book;
 ...
 */
public class Books {
	private static Logger logger = LoggerFactory.getLogger(Books.class);
	...
	public static void main(String[] args) {
	    ...
	    post(new Route("/books") {
			...
			public Object handle(Request request, Response response) {
				...
				logger.info("Post Request.Criando Book {}", book.toString());
